                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" required class="form-control" name="name"
                                    value="{{ old('name', isset($project['name']) ? utf8_decode($project['name']) : '') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('sat_id') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ utf8_encode($user->sat_ruc ? $user->getSat->NucNomSat : '') }}" readonly>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group {{ $errors->has('leader_name') ? 'has-error' : '' }}">
                                <label for="exampleInputPassword1">Nombre del Representante del GO</label>
                                <input required type="text" class="form-control" name="leader_name"
                                    value="{{ old('leader_name', isset($project['leader_name']) ? $project['leader_name'] : '') }}"
                                    placeholder="Ingrese Nombre del Lider del Grupo">
                        ...
                        <div class="col-md-3">
                            <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                                ...
                                <input required type="number" class="form-control" name="phone"
                                    value="{{ old('phone', isset($project['phone']) ? $project['phone'] : '') }}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group {{ $errors->has('res_nro') ? 'has-error' : '' }}">
                                ...
                                <input required type="number" class="form-control" name="res_nro"
                                    value="{{ old('res_nro', isset($project['res_nro']) ? $project['res_nro'] : '') }}"
                                    placeholder="Ingrese Nro de Resolucion">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group {{ $errors->has('fechares') ? 'has-error' : '' }}">
                                ...
                                <input required type="date" class="form-control" name="fechares"
                                    value="{{ old('fechares', isset($project['fechares']) ? $project['fechares'] : '') }}"
                                    placeholder="Ingrese fecha de resolución">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group {{ $errors->has('ubicacion') ? 'has-error' : '' }}">
                                ...
                                <input required type="text" class="form-control" name="ubicacion"
                                    value="{{ old('ubicacion', isset($project['ubicacion']) ? $project['ubicacion'] : '') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group {{ $errors->has('coordenadax') ? 'has-error' : '' }}">
                                ...
                                <input required type="text" class="form-control" name="coordenadax"
                                    value="{{ old('coordenadax', isset($project['coordenadax']) ? $project['coordenadax'] : '') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group {{ $errors->has('coordenaday') ? 'has-error' : '' }}">
                                ...
                                <input required type="text" class="form-control" name="coordenaday"
                                    value="{{ old('coordenaday', isset($project['coordenaday']) ? $project['coordenaday'] : '') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('localidad') ? 'has-error' : '' }}">
                                ...
                                <input type="text" required class="form-control" name="localidad"
                                    value="{{ old('localidad', isset($project['localidad']) ? utf8_encode($project['localidad']) : '') }}"
            ...
            if (stateID) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('select[name="land_id"]').append(
                            '<option value="">Selecciona el Tipo de Terreno</option>');
                        $.each(data, function(key, value) {
                            $('select[name="land_id"]').append('<option value="' + key + '">' +
                                value + '</option>');
                        });
                    }
                });
            ...
            if (stateID) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('select[name="typology_id"]').append(
                            '<option value="">Selecciona la Tipologia</option>');
                        $.each(data, function(key, value) {
                            $('select[name="typology_id"]').append('<option value="' + key +
                                '">' + value + '</option>');
                        });
                    }
                });
