                                        ...
                                        @foreach ($docproyecto as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <form action="/levantarObs" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                ...
                                                <td>
                                                    @if ($project->getEstado && $project->getEstado->stage_id == 10 || $project->getEstado && $project->getEstado->stage_id == 14)
                                                        @if ($uploadedFiles[$item->document_id])
