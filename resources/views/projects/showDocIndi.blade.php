...
@section('content')
    ...
    <div class="invoice p-3 mb-3">
        ...
        <a href="{{ url('projects/'.$project->id) }}" class="btn btn-success float-right">
            <i class="fa fa-plus-circle"></i> Volver
        </a>
                ...
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                            ...
                            aria-selected="true">ADJUNTAR NO OBJECIÓN DEL INDI</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($uploadedFiles[$item->document_id])
                                                        ...
                                                        <form action="/levantarIndi" method="POST" enctype="multipart/form-data">
                                                            @csrf
    ...
    <script>
        ...
        function allchecked() {
            ...
            var no = 0;
                ...
                rows.forEach(row => {
                    const uploadForm = row.querySelector('form[action="/levantarIndi"]');
                    if (uploadForm) {
                        todosCargados = false;
                    }
                });
