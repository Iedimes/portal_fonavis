...
@section('body')
    ...
    <div class="d-flex">
        ...
        @if (Auth::user()->rol_app->dependency_id == 4)
            <div class="p-1" v-if="item.get_estado && item.get_estado.stage_id === 11 || item.get_estado &&item.get_estado.stage_id === 12">
        ...
        @if (Auth::user()->rol_app->dependency_id == 5)
            <div class="p-1" v-if="item.get_estado && item.get_estado.stage_id === 16 || item.get_estado && item.get_estado.stage_id === 11">
