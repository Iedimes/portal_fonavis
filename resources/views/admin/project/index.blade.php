                                        ...
                                        <td>
                                            <div class="d-flex"
                                                ...
                                                @if (Auth::user()->rol_app->dependency_id == 1)
                                                    @include('admin.project.actions.dependency_1_dgfo')
                                                @endif

                                                {{-- DEPENDENCY 2 --}}
                                                @if (Auth::user()->rol_app->dependency_id == 2)
                                                    @include('admin.project.actions.dependency_2')
                                                @endif

                                                {{-- DEPENDENCY 3 --}}
                                                @if (Auth::user()->rol_app->dependency_id == 3)
                                                    @include('admin.project.actions.dependency_3')
                                                @endif

                                                {{-- DEPENDENCY 4 --}}
                                                @if (Auth::user()->rol_app->dependency_id == 4)
                                                    @include('admin.project.actions.dependency_4')
                                                @endif

                                                {{-- DEPENDENCY 5 --}}
                                                @if (Auth::user()->rol_app->dependency_id == 5)
                                                    @include('admin.project.actions.dependency_5')
                                                @endif
