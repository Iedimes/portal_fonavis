...
@section('body')
    ...
    <project-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/projects') }}'" inline-template>
                    ...
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'">{{ trans('admin.project.columns.id') }}
                                        </th>
                                        <th is='sortable' :column="'name'">{{ trans('admin.project.columns.name') }}
                                        </th>
                                        <th is='sortable' :column="'phone'">{{ trans('admin.project.columns.phone') }}
                                        </th>
                                        <th is='sortable' :column="'sat_id'">
                                            {{ trans('admin.project.columns.sat_id') }}</th>
                                        <th is='sortable' :column="'sat_nombre'">
                                            {{ trans('admin.project.columns.sat_nombre') }}</th>
                                        <th is='sortable' :column="'state_id'">
                                            {{ trans('admin.project.columns.state_id') }}</th>
                                        <th is='sortable' :column="'city_id'">
                                            {{ trans('admin.project.columns.city_id') }}</th>
                                        <th is='sortable' :column="'modalidad_id'">
                                            {{ trans('admin.project.columns.modalidad_id') }}</th>
                                        <th is='sortable' :column="'leader_name'">
                                            {{ trans('admin.project.columns.leader_name') }}</th>
                                        <th is='sortable' :column="'localidad'">
                                            {{ trans('admin.project.columns.localidad') }}</th>
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="16">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/projects')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/projects/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                                        ...
                                        <td>
                                            <span>
                                                ...
                                                <button v-else-if="item.get_estado && item.get_estado.stage_id === 2"
                                                    class="btn" style="background-color: orange; color: white;">
                                                    REVISION PRELIMINAR
                                                </button>
                                                <button v-else-if="item.get_estado && item.get_estado.stage_id === 3"
                                                    class="btn" style="background-color: rgb(3, 78, 20); color: white;">
                                                    APROBADO DGJN
                                                </button>
                                                ...
                                                <button v-else-if="item.get_estado && item.get_estado.stage_id === 6"
                                                    class="btn" style="background-color: red; color: white;">
                                                    RECHAZADO DGJN
                                                </button>
                                                ...
                                                <button v-else-if="item.get_estado && item.get_estado.stage_id === 8"
                                                    class="btn" style="background-color: purple; color: white;">
                                                ...
                                                <button v-else-if="item.get_estado && item.get_estado.stage_id === 20"
                                                    class="btn" style="background-color: rgb(3, 63, 6); color: white;">
                                                    ADJUDICADO
                                                </button>
                                        ...
                                        <td>
                                            <div class="d-flex"
                                                ...
                                                @if (Auth::user()->rol_app->dependency_id == 1)
                                                    ...
                                                    {{-- Stages FONAVIS --}}
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 1">
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 2">
                                                        <a class="btn btn-sm btn-success"
                                                            :href="item.resource_url + '/showVERDOCFONAVIS'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.showverdocfonavis') }}"
                                                            role="button">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 3">
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showFONAVIS'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 4">
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showFONAVIS'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 6">
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showFONAVIS'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 8">
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showFONAVIS'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 21">
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showFONAVIS'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 9">
                                                        <a class="btn btn-sm btn-warning"
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 11">
                                                        <a class="btn btn-sm btn-warning"
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 13">
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showFONAVIS'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 17">
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showFONAVISADJ'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                ...
                                                @if (Auth::user()->rol_app->dependency_id == 2)
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && [2,4,6].includes(item.get_estado.stage_id)">
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showDGJN'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                    ...
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 5">
                                                        <a class="btn btn-sm btn-warning"
                                                ...
                                                @if (Auth::user()->rol_app->dependency_id == 3)
                                                    <div class="p-1"
                                                        v-if="item.get_estado && item.get_estado.stage_id === 8">
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showDGSO'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                ...
                                                @if (Auth::user()->rol_app->dependency_id == 4)
                                                    <div class="p-1"
                                                        ...
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showDIGH'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                ...
                                                @if (Auth::user()->rol_app->dependency_id == 5)
                                                    <div class="p-1"
                                                        ...
                                                        <a class="btn btn-sm btn-warning"
                                                            :href="item.resource_url + '/showDSGO'"
                                                            title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                            role="button">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                ...
                                                <div class="p-1">
                                                    <a class="btn btn-sm"
                                                        style="background-color: #ec600e; color: #b5bbbb;"
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary " href="{{ url('admin/projects/create') }}" role="button"><i
                                        class="fa fa-plus"></i>&nbsp; {{ trans('admin.project.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
