...
@section('body')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @else
                @if (
                    ($project->getEstado->stage_id == 2 ||
                        $project->getEstado->stage_id == 3 ||
                        $project->getEstado->stage_id == 4 ||
                        $project->getEstado->stage_id == 6) &&
                        Auth::user()->rol_app->dependency_id == 2)
            ...
            <a href="{{ url('admin/projects/' . $project->id . '/historial') }}" class="btn btn-warning"
                style="float: right;">HISTORIAL DEL PROYECTO</a>
    ...
    <div class="card">
        <div class="card-header text-center">
            DOCUMENTOS PRESENTADOS<a href="{{ url('admin/projects') }}" class="btn btn-primary"
