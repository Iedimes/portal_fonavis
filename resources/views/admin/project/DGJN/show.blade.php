    ...
    <div class="card-body">
        <div class="row invoice-info">
            ...
            @else
                    ...
                    @if ( ($project->getEstado->stage_id == 2 || $project->getEstado->stage_id == 3 || $project->getEstado->stage_id == 4 || $project->getEstado->stage_id == 6) && Auth::user()->rol_app->dependency_id == 2)
