    ...
    <div class="card-body">
        <div class="row invoice-info">
            ...
            @else
                    ...
                    @if ( $project->getEstado->stage_id == 12 && Auth::user()->rol_app->dependency_id == 4 || $project->getEstado->stage_id == 11 && Auth::user()->rol_app->dependency_id == 4)
...
@if (($project->getEstado->stage_id == 11 || $project->getEstado->stage_id == 12 || $project->getEstado->stage_id == 14) && Auth::user()->rol_app->dependency_id == 4)
<div class="card mt-4">
