...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('record'), 'has-success': fields.record && fields.record.valid }">
    <label for="record" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('NOTIFICACION') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        ...
        id="record" name="record" placeholder="{{ trans('NOTIFICACION') }}"></textarea>
