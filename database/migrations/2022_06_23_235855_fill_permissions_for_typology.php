...
class FillPermissionsForTypology extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypology constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.typology',
            'admin.typology.index',
            'admin.typology.create',
            'admin.typology.show',
            'admin.typology.edit',
            'admin.typology.delete',
            'admin.typology.bulk-delete',
        ]);
