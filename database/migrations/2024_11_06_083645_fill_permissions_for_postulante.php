...
class FillPermissionsForPostulante extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPostulante constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.postulante',
            'admin.postulante.index',
            'admin.postulante.create',
            'admin.postulante.show',
            'admin.postulante.edit',
            'admin.postulante.delete',
            'admin.postulante.bulk-delete',
        ]);
