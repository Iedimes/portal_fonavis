...
class FillPermissionsForDiscapacidad extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDiscapacidad constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.discapacidad',
            'admin.discapacidad.index',
            'admin.discapacidad.create',
            'admin.discapacidad.show',
            'admin.discapacidad.edit',
            'admin.discapacidad.delete',
            'admin.discapacidad.bulk-delete',
        ]);
