...
class FillPermissionsForProjectStatus extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectStatus constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.project-status.index',
            'admin.project-status.create',
            'admin.project-status.show',
            'admin.project-status.edit',
            'admin.project-status.delete',
            'admin.project-status.bulk-delete',
        ]);
