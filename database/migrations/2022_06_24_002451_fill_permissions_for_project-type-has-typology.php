...
class FillPermissionsForProjectTypeHasTypology extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectTypeHasTypology constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.project-type-has-typology',
            'admin.project-type-has-typology.index',
            'admin.project-type-has-typology.create',
            'admin.project-type-has-typology.show',
            'admin.project-type-has-typology.edit',
            'admin.project-type-has-typology.delete',
            'admin.project-type-has-typology.bulk-delete',
        ]);
