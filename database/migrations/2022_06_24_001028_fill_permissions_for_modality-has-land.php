...
class FillPermissionsForModalityHasLand extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForModalityHasLand constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.modality-has-land',
            'admin.modality-has-land.index',
            'admin.modality-has-land.create',
            'admin.modality-has-land.show',
            'admin.modality-has-land.edit',
            'admin.modality-has-land.delete',
            'admin.modality-has-land.bulk-delete',
        ]);
