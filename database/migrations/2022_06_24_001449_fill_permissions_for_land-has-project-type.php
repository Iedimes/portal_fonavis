...
class FillPermissionsForLandHasProjectType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLandHasProjectType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.land-has-project-type',
            'admin.land-has-project-type.index',
            'admin.land-has-project-type.create',
            'admin.land-has-project-type.show',
            'admin.land-has-project-type.edit',
            'admin.land-has-project-type.delete',
            'admin.land-has-project-type.bulk-delete',
        ]);
