...
class FillPermissionsForDocumentCheck extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDocumentCheck constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.document-check.index',
            'admin.document-check.create',
            'admin.document-check.show',
            'admin.document-check.edit',
            'admin.document-check.delete',
            'admin.document-check.bulk-delete',
        ]);
