...
class FillPermissionsForProjectHasExpediente extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectHasExpediente constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.project-has-expediente',
            'admin.project-has-expediente.index',
            'admin.project-has-expediente.create',
            'admin.project-has-expediente.show',
            'admin.project-has-expediente.edit',
            'admin.project-has-expediente.delete',
            'admin.project-has-expediente.bulk-delete',
        ]);
