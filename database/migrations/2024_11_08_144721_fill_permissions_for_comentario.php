...
class FillPermissionsForComentario extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForComentario constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.comentario',
            'admin.comentario.index',
            'admin.comentario.create',
            'admin.comentario.show',
            'admin.comentario.edit',
            'admin.comentario.delete',
            'admin.comentario.bulk-delete',
        ]);
