...
class FillPermissionsForProjectOld extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectOld constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.project-old',
            'admin.project-old.index',
            'admin.project-old.create',
            'admin.project-old.show',
            'admin.project-old.edit',
            'admin.project-old.delete',
            'admin.project-old.bulk-delete',
        ]);
