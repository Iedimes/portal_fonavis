...
class FillPermissionsForAdminUsersDependency extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdminUsersDependency constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.admin-users-dependency',
            'admin.admin-users-dependency.index',
            'admin.admin-users-dependency.create',
            'admin.admin-users-dependency.show',
            'admin.admin-users-dependency.edit',
            'admin.admin-users-dependency.delete',
            'admin.admin-users-dependency.bulk-delete',
        ]);
